/*
  This module provides the loadExternalTransferInterface function which is
  responsible for adding the custom React components that support the
  external-transfer feature. It is called from DialpadPlugin.init.
*/
...
export const loadExternalTransferInterface = (flex, manager) => {
  ...
  // add translationStrings into manager.strings, preserving what's already there
  // this allows language to be updated outside of updating this plugin
