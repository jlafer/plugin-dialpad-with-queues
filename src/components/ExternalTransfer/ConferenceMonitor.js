/*
  This is a hidden React component that simply monitors changes with the
  current conference call (if any) and toggles the 'endConferenceOnExit'
  property to false when a third party is added and true when the number
  of participants drops below three. It gets access to the information via
  the 'task.conference' prop, since it's added under the CallCanvas.  
*/
