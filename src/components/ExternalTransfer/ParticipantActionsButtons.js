/*
  This component is added to both the full- and narrow-width ParticipantCanvas.
  It provides Hold/Unhold and Remove participant buttons. It also renders a
  modal confirmation dialog if the user clicks on the Remove button.
  The button handlers invoke (Un)HoldParticipant and KickParticipant Actions,
  getting the correct participant SID and type from the 'participant' prop
  passed by its parent (ParticipantCanvas).
*/
